...
import { MessageSquare, BookOpen, Search, User, LogOut, FileText } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <Link to="/notes" className="group">
              <div className="gradient-card rounded-2xl p-6 md:p-8 shadow-soft border border-border hover:shadow-divine transition-all duration-300">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-secondary/10 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform">
                  <FileText className="w-6 h-6 md:w-8 md:h-8 text-secondary" />
                </div>
                <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-3 text-foreground">Personal Notes</h3>
                <p className="text-muted-foreground">
                  Save and organize your theological notes and ideas
                </p>
              </div>
            </Link>
          </div>
