...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock registration - in production this would connect to backend
    toast({
      title: "Account created!",
      description: "Welcome to PreachBro. Let's get started!",
    });
    navigate("/dashboard");
  };
      ...
      <div className="w-full max-w-md">
        <div className="gradient-card rounded-2xl p-8 shadow-divine border border-border">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Create your account to begin your journey.</p>
          </div>
